...
function RegistrationList({ registrations, teachers = [], showCancelButton = true }) {
    ...
    // 取消报名处理
    const handleCancelRegistration = async (registrationId, competitionName)=>{
        if (!window.confirm(`确定要取消报名「${competitionName}」吗？\n\n取消后将释放1个名额，此操作不可撤销。`)) {
            return;
        }
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$8a9989__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelRegistration"])(registrationId);
            if (result.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result.message || '取消报名失败');
            }
        } catch (error) {
            console.error('取消报名失败:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : '取消报名失败，请稍后重试');
        }
    };
    // 检查是否可以取消报名
                        ...
                        children: [
                            ...
                            (registration.status?.toString().toUpperCase() === 'REJECTED_RETRY' || registration.status?.toString().toUpperCase() === 'REJECTED_FINAL' || registration.status?.toString().toUpperCase() === 'REJECTED') && registration.feedback && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    registration.status?.toString().toUpperCase() === 'REJECTED_RETRY' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                canCancelRegistration(registration) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    variant: "outline",
                                                    onClick: ()=>handleCancelRegistration(registration.id, registration.competition.name),
                                    ...
                                    registration.status?.toString().toUpperCase() !== 'REJECTED_RETRY' && canCancelRegistration(registration) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RegistrationList, "GzwwbI07aV/MiQrZoK+YaLwGYMc=", false, function() {
    return [
...
//# sourceMappingURL=src_61525559._.js.map