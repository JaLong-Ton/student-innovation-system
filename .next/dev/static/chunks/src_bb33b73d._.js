...
function useCurrentUser() {
    _s();
    const { user, isLoaded, isSignedIn } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$react$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUser"])();
    return {
        user,
        isLoaded,
        isSignedIn,
...
_s(useCurrentUser, "cRrC48t6W2ulRc4ezTiP9HMMYBQ=", false, function() {
    return [
...
function Header() {
    _s();
    const { isSignedIn, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentUser"])();
...
_s(Header, "tsbURivubzaBv1AFpuwGxXuqAvI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$user$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentUser"]
    ];
});
_c = Header;
var _c;
...
//# sourceMappingURL=src_bb33b73d._.js.map