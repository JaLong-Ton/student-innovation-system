...
function RegistrationList({ registrations, teachers = [], showCancelButton = true }) {
    ...
    const handleCancelRegistration = async (registrationId, competitionName)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$8a9989__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["cancelRegistration"])(registrationId);
            if (result.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(result.message || '取消报名失败');
            }
        } catch (error) {
            console.error('取消报名失败:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error instanceof Error ? error.message : '取消报名失败，请稍后重试');
        }
    };
    // 检查是否可以取消报名
...
//# sourceMappingURL=src_2430b22e._.js.map