...
"[project]/src/app/actions/data:88b8db [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$88b8db__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:88b8db [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function RegisterButton({ competitionId, isRegistered, isExpired, teachers }) {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$88b8db__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["registerCompetition"])({
                competitionId,
                ...data
            });
            if (result.success) {
...
//# sourceMappingURL=src_abe26884._.js.map