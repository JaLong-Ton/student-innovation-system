...
"[project]/src/app/actions/data:73d4bf [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$73d4bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:73d4bf [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$610b50__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/actions/data:610b50 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function RegistrationDataTable({ registrations }) {
    ...
    const handleBatchApprove = ()=>{
        ...
        startTransition(async ()=>{
            ...
            // 2. 后台静默发送真实请求
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$73d4bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["batchReviewRegistrations"])(selectedIds, 'APPROVED');
                if (result.success) {
                                                            ...
                                                            onReview: async (id, status, feedback)=>{
                                                                return new Promise((resolve)=>{
                                                                    startTransition(async ()=>{
                                                                        ...
                                                                        // 2. 后台静默发送真实请求
                                                                        try {
                                                                            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$data$3a$610b50__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["reviewRegistration"])(id, status, feedback);
                                                                            if (result.success) {
...
//# sourceMappingURL=src_d18619a4._.js.map