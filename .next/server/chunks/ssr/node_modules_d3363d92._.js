...
2) With environment variables e.g.
   ...
   NEXT_PUBLIC_CLERK_IS_SATELLITE='true'`,am=()=>an("getAuth",void 0,aj.middlewareFileReference),an=(a="auth",b,c="middleware")=>`Clerk: ${a}() was called but Clerk can't detect usage of clerkMiddleware(). Please ensure the following:
...
Original error: ${a}`)}}function p(a){var b;let c=a.split(";").map(a=>a.trim()),d=c.find(a=>a.startsWith("script-src"))||c.find(a=>a.startsWith("default-src"));if(!d)return;let e=null==(b=d.split(" ").slice(1).map(a=>a.trim()).find(a=>a.startsWith("'nonce-")&&a.length>8&&a.endsWith("'")))?void 0:b.slice(7,-1);if(e){if(/[&><\u2028\u2029]/g.test(e))throw Error("Nonce value from Content-Security-Policy contained invalid HTML escape characters, which is disallowed for security reasons. Make sure that your nonce value does not contain the following characters: `<`, `>`, `&`");return e}}a.s(["ClerkUseCacheError",()=>f,"USE_CACHE_ERROR_MESSAGE",()=>n,"buildRequestLike",()=>o,"getScriptNonceFromHeader",()=>p,"isClerkUseCacheError",()=>g,"isNextjsUseCacheError",()=>m,"isPrerenderingBailout",()=>l])},79187,a=>{"use strict";var b=a.i(347);let c=a=>{if(!a||"string"!=typeof a)return a;try{return(a||"").replace(/^(sk_(live|test)_)(.+?)(.{3})$/,"$1*********$4")}catch{return""}},d=a=>(Array.isArray(a)?a:[a]).map(a=>"string"==typeof a?c(a):JSON.stringify(Object.fromEntries(Object.entries(a).map(([a,b])=>[a,c(b)])),null,2)).join(", "),e=(a,c)=>(...e)=>{let f=("string"==typeof a?()=>{let c=[],e=!1;return{enable:()=>{e=!0},debug:(...a)=>{e&&c.push(a.map(a=>"function"==typeof a?a():a))},commit:()=>{if(e){var f,g;for(let b of(console.log((f=a,`[clerk debug start: ${f}]`)),c)){let a=d(b);a=a.split("\n").map(a=>`  ${a}`).join("\n"),process.env.VERCEL&&(a=function(a,b){let c=new TextEncoder,d=new TextDecoder("utf-8"),e=c.encode(a).slice(0,4096);return d.decode(e).replace(/\uFFFD/g,"")}(a,4096)),console.log(a)}console.log((g=a,`[clerk debug end: ${g}] (@clerk/nextjs=7.0.1,next=${b.default.version},timestamp=${Math.round(new Date().getTime()/1e3)})`))}}}}:a)(),g=c(f);try{let a=g(...e);if("object"==typeof a&&"then"in a&&"function"==typeof a.then)return a.then(a=>(f.commit(),a)).catch(a=>{throw f.commit(),a});return f.commit(),a}catch(a){throw f.commit(),a}};a.s(["withLogger",()=>e],79187)},5072,a=>{"use strict";a.i(48917);var b=a.i(46030);a.i(70396);var c=a.i(73727),d=a.i(82849);a.i(36401);var e=a.i(11286),f=a.i(79187),g=a.i(95374),h=a.i(75077),i=a.i(63365),j=a.i(54772);(({debugLoggerName:a,noAuthStatusMessage:c})=>(0,f.withLogger)(a,a=>(d,f)=>((0,e.isTruthy)((0,i.getHeader)(d,b.constants.Headers.EnableDebug))&&a.enable(),(0,j.assertAuthStatus)(d,c),((b,c={})=>(0,g.getSessionAuthDataFromRequest)(b,{...c,logger:a,acceptsToken:null==c?void 0:c.acceptsToken}))(d,{...f,logger:a,acceptsToken:null==f?void 0:f.acceptsToken}))))({debugLoggerName:"getAuth()",noAuthStatusMessage:(0,h.getAuthAuthHeaderMissing)()});let k={NOT_FOUND:404,FORBIDDEN:403,UNAUTHORIZED:401};Object.values(k);let l="NEXT_HTTP_ERROR_FALLBACK";function m(){let a=Error(l);throw a.digest=`${l};${k.UNAUTHORIZED}`,a}var n=a.i(95194);let o=a=>{var c,d;return!!a.headers.get(n.constants.Headers.NextUrl)&&((null==(c=a.headers.get(b.constants.Headers.Accept))?void 0:c.includes("text/x-component"))||(null==(d=a.headers.get(b.constants.Headers.ContentType))?void 0:d.includes("multipart/form-data"))||!!a.headers.get(n.constants.Headers.NextAction))},p=a=>!!a.headers.get(n.constants.Headers.NextUrl)&&!o(a)||q(),q=()=>{let a=globalThis.fetch;if(!("__nextPatched"in a&&!0===a.__nextPatched))return!1;let{page:b}=a.__nextGetStaticStore().getStore()||{};return!!b},r=a=>!!a.headers.get(n.constants.Headers.NextjsData);var s=a.i(77380),t=a.i(24202);let u=async k=>{var l;a.r(25497);try{let m=await (0,t.buildRequestLike)(),n=async()=>{try{let b=await a.A(77710).then(a=>a.hasSrcAppDir()),c="middleware or proxy"===s.middlewareFileReference?"middleware.(ts|js) or proxy.(ts|js)":"middleware.(ts|js)";return[`Your ${s.middlewareFileReference} file exists at ./${b?"src/":""}${c}`]}catch{return[]}},o=await (({debugLoggerName:c,noAuthStatusMessage:d})=>(0,f.withLogger)(c,c=>async(f,h)=>{if((0,e.isTruthy)((0,i.getHeader)(f,b.constants.Headers.EnableDebug))&&c.enable(),!(0,i.detectClerkMiddleware)(f)){let b=await a.A(77710).then(a=>a.suggestMiddlewareLocation()).catch(()=>void 0);if(b)throw Error(b);(0,j.assertAuthStatus)(f,d)}return((a,b={})=>(0,g.getAuthDataFromRequest)(a,{...b,logger:c,acceptsToken:null==b?void 0:b.acceptsToken}))(f,{...h,logger:c,acceptsToken:null==h?void 0:h.acceptsToken})}))({debugLoggerName:"auth()",noAuthStatusMessage:(0,h.authAuthHeaderMissing)("auth",await n(),s.middlewareFileReference)})(m,{treatPendingAsSignedOut:null==k?void 0:k.treatPendingAsSignedOut,acceptsToken:null!=(l=null==k?void 0:k.acceptsToken)?l:b.TokenType.SessionToken}),p=(0,i.getAuthKeyFromRequest)(m,"ClerkUrl"),q=(...a)=>{let{returnBackUrl:e}=a[0]||{},f=(0,b.createClerkRequest)(m),g=f.clerkUrl.searchParams.get(b.constants.QueryParameters.DevBrowser)||f.cookies.get(b.constants.Cookies.DevBrowser),h=(0,i.getHeader)(m,b.constants.Headers.ClerkRequestData),k=(0,j.decryptClerkRequestData)(h);return[(0,b.createRedirect)({redirectAdapter:c.redirect,devBrowserToken:g,baseUrl:f.clerkUrl.toString(),publishableKey:k.publishableKey||d.PUBLISHABLE_KEY,signInUrl:k.signInUrl||d.SIGN_IN_URL,signUpUrl:k.signUpUrl||d.SIGN_UP_URL,sessionStatus:o.tokenType===b.TokenType.SessionToken?o.sessionStatus:null,isSatellite:k.isSatellite}),null===e?"":e||(null==p?void 0:p.toString())]};if(o.tokenType===b.TokenType.SessionToken)return Object.assign(o,{redirectToSignIn:(a={})=>{let[b,c]=q(a);return b.redirectToSignIn({returnBackUrl:c})},redirectToSignUp:(a={})=>{let[b,c]=q(a);return b.redirectToSignUp({returnBackUrl:c})}});return o}catch(a){if((0,t.isClerkUseCacheError)(a))throw a;if((0,t.isNextjsUseCacheError)(a))throw new t.ClerkUseCacheError(`${t.USE_CACHE_ERROR_MESSAGE}

Original error: ${a.message}`,a);throw a}};u.protect=async(...d)=>{var e,f;a.r(25497);let g=await (0,t.buildRequestLike)(),h=(null==(e=null==d?void 0:d[0])?void 0:e.token)||(null==(f=null==d?void 0:d[1])?void 0:f.token)||b.TokenType.SessionToken,i=await u({acceptsToken:h});return(function(a){let{redirectToSignIn:c,authObject:d,redirect:e,notFound:f,request:g,unauthorized:h}=a;return async(...a)=>{var i,j,k,l,m,n,q,s;let t=(a=>{if(a&&!a.unauthenticatedUrl&&!a.unauthorizedUrl&&!a.token&&(1!==Object.keys(a).length||!("token"in a)))return a})(a[0]),u=(null==(i=a[0])?void 0:i.unauthenticatedUrl)||(null==(j=a[1])?void 0:j.unauthenticatedUrl),v=(null==(k=a[0])?void 0:k.unauthorizedUrl)||(null==(l=a[1])?void 0:l.unauthorizedUrl),w=(null==(m=a[0])?void 0:m.token)||(null==(n=a[1])?void 0:n.token)||b.TokenType.SessionToken,x=()=>d.tokenType===b.TokenType.SessionToken&&(0,b.isTokenTypeAccepted)(b.TokenType.SessionToken,w)?v?e(v):f():h();if(!(0,b.isTokenTypeAccepted)(d.tokenType,w))return x();if(d.tokenType!==b.TokenType.SessionToken)return d.isAuthenticated?d:x();if("pending"===d.sessionStatus||!d.userId){return u?e(u):"document"===(q=g).headers.get(b.constants.Headers.SecFetchDest)||"iframe"===q.headers.get(b.constants.Headers.SecFetchDest)||(null==(s=q.headers.get(b.constants.Headers.Accept))?void 0:s.includes("text/html"))||p(q)||r(q)?c():o(g)?h():f()}return t?"function"==typeof t?t(d.has)?d:x():d.has(t)?d:x():d}})({request:g,authObject:i,redirectToSignIn:i.redirectToSignIn,notFound:c.notFound,redirect:c.redirect,unauthorized:m})(...d)},a.s(["auth",()=>u],5072)}];

//# sourceMappingURL=node_modules_d3363d92._.js.map