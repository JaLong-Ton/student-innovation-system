...
export default function ProfileInteractivePage() {
  return (
    <>
      <div className="container mx-auto px-4 py-8">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h1 className="text-3xl font-bold text-gray-900">个人中心（交互测试）</h1>
            <p className="text-gray-600">这个页面包含完整的交互功能，包括表单提交和 Toast 提示</p>
